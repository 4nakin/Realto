package com.touchmenotapps.realto.model;
...
public class PropertyDetailsObject {
	...
	/**
	 * @param mPropertyTitle the mPropertyTitle to set
	 */
	public void setPropertyTitle(String mPropertyTitle) {
	...
	/**
	 * @param mPropertyAddress the mPropertyAddress to set
	 */
	public void setPropertyAddress(String mPropertyAddress) {
	...
	/**
	 * @param mPropertyPrice the mPropertyPrice to set
	 */
	public void setPropertyPrice(String mPropertyPrice) {
	...
	/**
	 * @param mPropertyDescription the mPropertyDescription to set
	 */
	public void setPropertyDescription(String mPropertyDescription) {
	...
	/**
	 * @param mPropertyImagesURL the mPropertyImagesURL to set
	 */
	public void setPropertyImagesURL(String[] mPropertyImagesURL) {
	...
	/**
	 * @param mPropertyRoomCount the mPropertyRoomCount to set
	 */
	public void setPropertyRoomCount(String[] mPropertyRoomCount) {
	...
	/**
	 * @param mPropertyUploaderMail the mPropertyUploaderMail to set
	 */
